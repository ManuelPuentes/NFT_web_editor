	...
	<section class="error">
		...
		<div class="error__content">
			<div class="error__message message">
				<h1 class="message__title text-gray-500 dark:text-gray-400">Page Not Found</h1>
				<p class="message__text text-gray-500 dark:text-gray-400">
					We're sorry, the page you were looking for isn't found here. The link you followed may
					either be broken or no longer exists. Please try again, if you consider this is a bug pls
