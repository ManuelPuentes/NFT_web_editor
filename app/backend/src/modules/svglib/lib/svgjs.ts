...
export const svgElement = (
  ...
  switch (name) {
    case ElementType.CIRCLE:
      element = circleElement(svg_data, parent_element, element_id);
      break;
    case ElementType.CLIP:
      element = clipElement(svg_data, parent_element, element_id);
      break;

    case ElementType.DEFS:
      element = defsElement(svg_data, parent_element, element_id);
      break;

    case ElementType.ELLIPSE:
      element = ellipseElement(svg_data, parent_element, element_id);
      break;

    case ElementType.GROUP:
      element = groupElement(svg_data, parent_element, element_id);
      break;

    case ElementType.IMAGE:
      element = imageElement(svg_data, parent_element, element_id);
      break;

    case ElementType.LINE:
      element = lineElement(svg_data, parent_element, element_id);
      break;

    case ElementType.LINEAR_GRADIENT:
      element = linearGradientElement(svg_data, parent_element, element_id);
      break;

    case ElementType.PATH:
      element = pathElement(svg_data, parent_element, element_id);
      break;

    case ElementType.POLYGON:
      element = polygonElement(svg_data, parent_element, element_id);
      break;

    case ElementType.POLYLINE:
      element = polylineElement(svg_data, parent_element, element_id);
      break;

    case ElementType.RADIAL_GRADIENT:
      element = radialGradientElement(svg_data, parent_element, element_id);
      break;

    case ElementType.RECT:
      element = rectElement(svg_data, parent_element, element_id);
      break;

    case ElementType.STYLE:
      element = styleElement(svg_data, parent_element, element_id);
      break;
