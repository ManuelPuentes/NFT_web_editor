...
const isClass = (attr_key: string, attributes: Record<string, string>, id: string) => {
    if (attr_key == "class") {
...
const isID = (attr_key: string, attributes: Record<string, string>, id: string) => {
    if (attr_key == "id") {
...
const isXlinkHref = (attr_key: string, attributes: Record<string, string>, id: string) => {
...
const isURL = (attr_key: string, attributes: Record<string, string>, id: string) => {
